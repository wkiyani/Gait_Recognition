# -*- coding: utf-8 -*-
"""
Created on Sat Apr  6 21:11:27 2019
...
class NewRecognitionSet(wx.Frame):
    ...
    def TrainingAlgOp(self, event):
        ...
        if SUBJECTNAME is '':
            ...
            ADFrame(title=self.selectedAlg)
            self.Close()
    ...
    def OnRadiogroup(self, e):
       rb = e.GetEventObject()
       print (rb.GetLabel(),' is selected as Alg')
       self.selectedAlg = rb.GetLabel()
       print (self.selectedAlg,' is selected as Alg2')
